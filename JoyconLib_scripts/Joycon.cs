...
public class Joycon
{
    ...
    {
        Vector3 v1 = (new Vector3(i_b.x, j_b.x, k_b.x));
        Vector3 v2 = (new Vector3(i_b.y, j_b.y, k_b.y));
        Vector3 v3 = (new Vector3(i_b.z, j_b.z, k_b.z));
        if (v2 != Vector3.zero){
		    return Quaternion.LookRotation(v1,v3);
        }else{
